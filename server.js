...
const JWT_SECRET = process.env.JWT_SECRET || 'ygy_guinee_2024_secret';
...
function auth(req, res, next) {
  ...
  try {
    ...
    console.warn('[AUTH] Échec token:', err.message, '| route:', req.path, '| secret défini:', !!process.env.JWT_SECRET);
